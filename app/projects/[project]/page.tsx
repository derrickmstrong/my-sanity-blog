...
export default async function Project({ params } : ProjectProps) {
    ...
    return (
      <div>
        ...
        {/* content goes here */}
        <div className="text-lg text-gray-700 mt-5 mx-2"><PortableText value={project.content} /></div>

        {/* image goes here */}
        <Image src={project.image} alt="" width={1920} height={1080} className="object-cover rounded-lg border border-gray-200 mt-5" />
      </div>
    );
}